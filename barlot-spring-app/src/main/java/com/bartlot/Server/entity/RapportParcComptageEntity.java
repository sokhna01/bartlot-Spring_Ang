...
// @ElementCollection
// @Column(name = "pdc_toutes_valeurs_du_jour_absentes", columnDefinition =
// "text")
// private List<String> pdcToutesValeursDuJourAbsentes;

// @ElementCollection
// @Column(name = "pdc_toutes_valeurs_absentes_est_<_=_3_jours_ouvres",
...
// @ElementCollection
// @Column(name = "pdc_avec_periodes_affectees_par_une_intervention",
// columnDefinition = "text")
// private List<String> pdcAvecPeriodesAffecteesParUneIntervention;

// @ElementCollection
// @Column(name = "pdc_avec_periodes_valeurs_absentes_<_=_1_heure",
// columnDefinition = "text")
// private List<String> pdcAvecPeriodesValeursAbsentesInfA1Heure;

// @ElementCollection
// @Column(name = "pdc_avec_periodes_valeurs_absentes_>_1_heure",
// columnDefinition = "text")
// private List<String> pdcAvecPeriodesValeursAbsentesSupA1Heure;

// @ElementCollection
// @Column(name = "pdc_avec_periodes_valeurs_nulles_<_=_1_heure",
// columnDefinition = "text")
// private List<String> pdcAvecPeriodesValeursNullesInfA1Heure;

// @ElementCollection
// @Column(name = "pdc_avec_periodes_valeurs_nulles_>_1_heure", columnDefinition
// = "text")
...
// @ElementCollection
// @Column(name = "periodes_avec_donnees_issues_cpt_se", columnDefinition =
// "text")
// private List<String> periodesAvecDonneesIssuesCptSe;

// @ElementCollection
// @Column(name = "periodes_avec_donnees_issues_cpt_ev", columnDefinition =
// "text")
