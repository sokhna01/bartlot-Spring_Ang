...
public class RapportPointComptageEntity {
    ...
    @Column(name = "nb_de_jours_avec_valeurs_absentes", columnDefinition = "integer[]")
    private Integer[] nbDeJoursAvecValeursAbsentes;// must_review

    @Column(name = "periodes_avec_intervention", columnDefinition = "integer[][]")
    private Integer[][] periodesAvecIntervention;// must_review

    @Column(name = "periodes_avec_valeurs_absentes_<_=_1_heure", columnDefinition = "integer[][]")
    ...
    @Column(name = "periodes_avec_valeurs_nulles_<_=_1_heure", columnDefinition = "integer[][]")
    ...
    @Column(name = "resultat_du_calcul_de_redondance", columnDefinition = "integer[]")
    private Integer[] resultatDuCalculDeRedondance; // must_review

    @Column(name = "periodes_avec_donnees_issues_cpt_re", columnDefinition = "integer")
    private Integer periodesAvecDonneesIssuesCptRe;

    @Column(name = "periodes_avec_donnees_issues_se", columnDefinition = "integer")
    private Integer periodesAvecDonneesIssuesSe;

    @Column(name = "periodes_avec_donnees_issues_ev", columnDefinition = "integer")
